...
class Logger {
    ...
    private static var sharedLoggers: [LoggerProtocol] {
        return shared?.loggers ?? []
    }
    
    private var loggers: [LoggerProtocol]
    
    init(_ loggers: [LoggerProtocol]) {
        self.loggers = loggers
    }
    
    private static let queue = DispatchQueue(label: "\(Logger.self)_Queue", qos: .background, target: nil)
     ...
     */
    class func verbose(_ category: LogCategory, _ msg: String,
     ...
     */
    class func debug(_ category: LogCategory, _ msg: String,
                     file: StaticString = #file, function: StaticString = #function, line: UInt = #line) {
        queue.async {
            for logger in sharedLoggers {
     ...
     */
    class func info(_ category: LogCategory, _ msg: String,
                    file: StaticString = #file, function: StaticString = #function, line: UInt = #line) {
        queue.async {
            for logger in sharedLoggers {
     ...
     */
    class func warning(_ category: LogCategory, _ msg: String,
                       file: StaticString = #file, function: StaticString = #function, line: UInt = #line) {
        queue.async {
            for logger in sharedLoggers {
     ...
     */
    class func error(_ category: LogCategory, _ msg: String,
                     file: StaticString = #file, function: StaticString = #function, line: UInt = #line) {
        queue.async {
            for logger in sharedLoggers {
     ...
     */
    class func fatalError(_ category: LogCategory, _ msg: String,
